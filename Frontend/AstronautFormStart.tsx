...
/*
Astronaut form: First page
Author: Alex Nicolellis

The starting page for the Astronaut form. It contains text entries for customer and Lely information.
*/

export const AstronautFormStart = () => {
  ...
  // Declare which variables will be transferred to the next page
  const nextPage = () => {
    navigation.navigate("AstronautForm2", {
      farm: cust_farm,
      first: cust_first,
      last: cust_last,
      num: cust_num,
    ...
    // Code to be run upon loading the page
    useEffect(() =>{
        const fetchUserData = async() => {
            try {
                ...
                // Find the user's existing customer data based on their known last name and customer number (required to be entered earlier in the app)
                ...
                // Pre-fill the text inputs based on the known data.
  ...
  // This form is a series of text inputs. Each is linked to a state variable.
  return (
    <SafeAreaView style={styles.container}>
      <ScrollView style={styles.scrollView}>
      <Text style={styles.header}>Handover Declaration: Declaration of Installation</Text>
      ...
      <TextInput style={styles.input} onChangeText={setCoordinatorName} value={lely_coordinatorname}
        placeholder="Name Responsible Project Coordinator" />
