...
/*
Horizon form: First page
Author: Alex Nicolellis

The starting page for the Horizon form. It contains text entries for customer and Lely information.
Similar to Astronaut page 1.
*/

export const HorizonFormStart = () => {
  ...
  const nextPage = () => {
    navigation.navigate("HorizonForm2", {
      farm: cust_farm,
      first: cust_first,
      last: cust_last,
      num: cust_num,
  ...
  return (
    <SafeAreaView style={styles.container}>
      ...
      <Text style={styles.header}>Horizon Server Installation Form</Text>
