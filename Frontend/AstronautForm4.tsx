...
import { AstronautData2 } from './Data/AstronautData'

/*
Astronaut form: Fourth page
Author: Alex Nicolellis

This page contains part of the Astronaut form checklist. Similar to Astronaut page 5.
*/

type Props = NativeStackScreenProps<RootStackParamList, 'AstronautForm4'>;
...
export const AstronautForm4 = ({route, navigation}: Props) => {
    const { farm,first,last,num,street,zip,city,country,
        ...
        checklistVals1, checklistRemarks1 } = route.params;
    ...
    useEffect(() =>{
        const fillRows = () => {
            for (var item of AstronautData2) {
    ...
    const nextPage = () => {
        navigation.navigate("AstronautForm5", {
            farm:farm,
            first:first,
            last:last,
            num:num,
            ...
            checklistVals1:checklistVals1,
            checklistRemarks1:checklistRemarks1,
            checklistVals2:getAllVals(rows),
            checklistRemarks2:getAllRemarks(rows),
        });
    };
